...
package org.wso2.connectedlap.plugin.constants;

import org.wso2.carbon.utils.CarbonUtils;
import java.io.File;

public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "CONNECTEDLAP";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "CONNECTEDLAP_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_CONNECTEDLAP";
    public static final String DEVICE_BATTERY_STATS = "DEVICE_BATTERY_USAGE_SUMMARY";
    public static final String DEVICE_CHARGER_STATS ="DEVICE_CHARGER_PLUGGED_IN_SUMMARY";
    ...
    public static final String MQTT_ADAPTER_NAME = "CONNECTEDLAP_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/CONNECTEDLAP/+/publisher";
